...
public class SignUpPanel2 extends JLabel {
	...
	public SignUpPanel2(int width, int height) {
		...
		try {
			submitImage = ImageIO.read(getClass().getResource("/images/submit.png"));
			submitPressedImage = ImageIO.read(getClass().getResource("/images/submitPressed.png"));
			backImage = ImageIO.read(getClass().getResource("/images/back.png"));
			backPressedImage = ImageIO.read(getClass().getResource("/images/backPressed.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
